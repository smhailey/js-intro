 ...
 * remember to return the array that now contains the url slugs
 */

function urlSlugs(arr) {

  let i = 0; //array index
  let j = 0; //string index

  // need to use nested for loops to step through strings to change " " to "-".
}